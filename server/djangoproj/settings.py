...
DEBUG = True
ALLOWED_HOSTS = ['localhost', 'https://sandhufia-8000.'\
                 'theianext-1-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai']
CSRF_TRUSTED_ORIGINS = ['https://sandhufia-8000.theianext-1-labs-prod-misc-tools-us-'\
                        'east-0.proxy.cognitiveclass.ai',
                        'https://sandhufia-8000.theiadockernext-1-labs-prod-theiak8s-'
